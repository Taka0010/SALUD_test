    ...
    <main class="main">
        <section class="service main__forBg main__inner">
            <div class="service__inner l-base">
                <div class="service__ttlBlock main__ttlBlock">
        ...
        <section class="servicePoints">
            <div class="servicePoints__inner l-base">
                <div class="servicePoints__container servicePoints__fst">
                ...
                <div class="servicePoints__container servicePoints__sec">
                ...
                <div class="servicePoints__container servicePoints__trd">
