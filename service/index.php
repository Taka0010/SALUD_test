    ...
    <main class="main">
        <section class="service main__forBg main__inner">
            <div class="service__inner l-base">
                <div class="service__ttlBlock main__ttlBlock wow fadeInUp">
                ...
                <div class="service__exp">
                    <div class="service__exp--txt wow fadeInUp">
        ...
        <section class="servicePoints">
            <div class="servicePoints__inner l-base">
                <div class="servicePoints__container servicePoints__fst wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="servicePoints__container servicePoints__sec wow fadeInUp" data-wow-delay=".2s">
